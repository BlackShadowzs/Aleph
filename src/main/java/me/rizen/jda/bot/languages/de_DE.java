...
public class de_DE implements Language {
    ...
    public String NORWEGIAN_BOKMAAL() {
        return "Norwegisch (Norsk Bokmål)";
    }

    @Override
    public String ROMANIAN() {
        return "Rumänisch (Română)";
    }
    ...
    public String ERROR_NAN() {
        return "Das ist keine gültige Zahl.";
    }
    ...
    public String LOGS_NOT_SET_FIELD_VALUE() {
        return "Benutze REPLACEsetlogs in dem Channel in dem du die Logs gesendet haben möchtest! (Admin or above)";
    }

    @Override
    public String SUCCESS_REWIND() {
        return "Erfolgreich REPLACE zurückgespult!";
    }

    @Override
    public String SUCCESS_FORWARD() {
        return "Erfolgreich REPLACE sekunden weitergeleitet!";
    }

    @Override
    public String LOGS_NOT_SET_FIELD_NAME() {
        return "Keine lust mehr auf diese Embeds in den event Channeln?";
    }
