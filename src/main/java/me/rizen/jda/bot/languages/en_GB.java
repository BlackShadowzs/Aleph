...
public class en_GB implements Language {
    ...
    public String ERROR_NAN() {
        return "This isn't a valid number.";
    }
    ...
    public String LOGS_NOT_SET_FIELD_VALUE() {
        return "Do REPLACEsetlogs in the channel which you want the logs to be sent in (Admin or above)";
    }

    @Override
    public String SUCCESS_REWIND() {
        return "Successfully rewound REPLACE seconds!";
    }
    ...
    public String LOGS_NOT_SET_FIELD_NAME() {
        return "Er du lei av å få disse embeds i event-kanalen?";
    }

    @Override
    public String PROVIDED_BY_RIZEN() {
        return "Levert til deg av "+Config.getInstance().getString("ownerTag");
    }
    ...
    public String UTIL_COMMANDS() {
        return "\n\n**• Blandede Kommandoer [REPLACE]**\n";
    }

    @Override
    public String IMAGE_COMMANDS() {
        return "\n\n**• Bilde-kommandoer [REPLACE]**\n";
    }

    @Override
    public String FUN_COMMANDS() {
        return "\n\n**• Morsomme Commands [REPLACE]**\n";
    }
    ...
    public String MUSIC_COMMANDS() {
        return "\n\n**• Musikk Commands [REPLACE]**\n";
    }

    @Override
    public String IN_PROPER_HTML() {
        return "Du må spesifisere ekte HTML!";
    }

    @Override
    public String LYRICS_FIELD_NAME() {
        return "Er ikke fulltekstene der?";
    }
    ...
    public String YODA_WOULD_SAY() {
        return "Yoda vil si: REPLACE";
    }

    @Override
    public String COCKTAIL_SERVING_GLASS() {
        return "Serveringsglass";
    }

    @Override
    public String COCKTAIL_INIT_DESCRIPTION() {
        return "Instruksjoner & Ingredienser:```yaml\n";
    }
    ...
    public String INVERT_MESSAGE() {
        return "Her er **REPLACE**s avatar, med `invert` filteret på.";
    }
